...
* [应用接口文档](app/README.md)
  ...
  * [数据通讯模块](app/port/README.md)
    * [数据交叉计算](app/port/calc.md)
    * [数据拼接](app/port/concat.md)
    * [数据流缓存](app/port/stream_buffer.md)
  * [工具类模块](app/utils/README.md)
    * [端口模块](app/utils/init.md)
    * [帮助模块](app/utils/helper.md)
    * [端口超时封装](tapp/utils/imeout_channel.md)
